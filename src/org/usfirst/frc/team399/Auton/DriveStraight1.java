...
public class DriveStraight1 extends CommandGroup {
	...
	private boolean bn1 = Supersystem.getInstance().gmbut1.get();
	private boolean bn2 = Supersystem.getInstance().gmbut2.get();
	
	public DriveStraight1(){
