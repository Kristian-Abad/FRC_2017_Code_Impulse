...
public class ForwardtoTurn extends Command{
	double targetInInches;
	double targetAngle;
	double time;
	public ForwardtoTurn(double targetininches, double angletarget, double time){
	...
	protected void execute() {
		...
		Supersystem.getInstance().drive.easyForwardTurn(pulse, angle, targetInInches, targetAngle);
		setTimeout(time);
		// TODO Auto-generated method stub
